...
public enum ShipType {
    ...
    public static ShipType getByTypeName(String shipTypeName) {
        return Stream.of(ShipType.values()).filter(
                shipType -> shipTypeName.equals(shipType.getShipTypeName())).findFirst().orElseThrow(
                () -> new IllegalArgumentException("Missing ship factory configuration"));
    }
